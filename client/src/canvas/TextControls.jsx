...
const TextControls = () => {
  ...
  return (
    <div className="absolute left-full ml-3 flex flex-wrap space-y-2  overflow-y-scroll w-100 h-80">
      <div className="flex items-center space-x-2">
        <span className="text-gray-700">Front Text:</span>
        <input
          type="text"
      ...
      <div className="flex items-center space-x-2">
        <span className="text-gray-700">Front text X axis :</span>
        <button
      ...
      <div className="flex items-center space-x-2">
        <span className="text-gray-700">Front text Y axis :</span>
        <button
          className="border border-gray-300 rounded-md p-2"
      ...
      <div className="flex items-center space-x-2">
        <span className="text-gray-700">Front text Z axis :</span>
        <button
          className="border border-gray-300 rounded-md p-2"
      ...
      <div className="flex items-center space-x-2">
        <span className="text-gray-700">Front Rotation Y :</span>
        <button
          className="border border-gray-300 rounded-md p-2"
      ...
      <div className="flex items-center space-x-2">
        <span className="text-gray-700">Front Rotation Z :</span>
        <button
          className="border border-gray-300 rounded-md p-2"
      ...
      <div className="flex items-center space-x-2">
        <span className="text-gray-700">Front Size X axis:</span>
        <button
          className="border border-gray-300 rounded-md p-2"
      ...
      <div className="flex items-center space-x-2">
        <span className="text-gray-700">Front Size Y axis:</span>
        <button
          className="border border-gray-300 rounded-md p-2"
      ...
      <div className="flex items-center space-x-2">
        <span className="text-gray-700">Front Size Z axis:</span>
        <button
          className="border border-gray-300 rounded-md p-2"
      ...
      <div className="flex items-center space-x-2">
        <span className="text-gray-700">Front Color:</span>
         <SketchPicker 
      ...
      {/*  Back text controls */}
      <div className="flex items-center space-x-2">
        <span className="text-gray-700">Back Text:</span>
        <input
          type="text"
          value={snap.backText}
      ...
      <div className="flex items-center space-x-2">
        <span className="text-gray-700">Back text X axis:</span>
         <button
            className="border border-gray-300 rounded-md p-2"
      ...
      <div className="flex items-center space-x-2">
        <span className="text-gray-700">Back text Z axis:</span>
        <button
          className="border border-gray-300 rounded-md p-2"
      ...
      <div className="flex items-center space-x-2">
        <span className="text-gray-700">Back Rotation X:</span>
        <button
          className="border border-gray-300 rounded-md p-2"
      ...
      <div className="flex items-center space-x-2">
        <span className="text-gray-700">Back Rotation Y:</span>
        <button
          className="border border-gray-300 rounded-md p-2"
      ...
      <div className="flex items-center space-x-2">
        <span className="text-gray-700">Back Rotation Z:</span>
        <button
          className="border border-gray-300 rounded-md p-2"
      ...
      <div className="flex items-center space-x-2">
        <span className="text-gray-700">Back Size X axis:</span>
         <button
            className="border border-gray-300 rounded-md p-2"
      ...
      <div className="flex items-center space-x-2">
         <span className="text-gray-700">Back Size Y axis:</span> 
         <button 
            className="border border-gray-300 rounded-md p-2" 
      ...
      <div className="flex items-center space-x-2">
      <span className="text-gray-700">Back Size Z axis:</span>
        <button
          className="border border-gray-300 rounded-md p-2"
      ...
      <div className="flex items-center space-x-2">
        <span className="text-gray-700">Back Front:</span>
      ...
      <div className="flex items-center space-x-2">
        <span className="text-gray-700">Back Color:</span>
        <SketchPicker 
