...
const LogoControls = () => {
  ...
  return (
    ...
    <div className="absolute left-full ml-3 w-[500px]">
      <div className="flex flex-col space-y-2">
        <div className="flex items-center space-x-2">
          <span className="text-gray-700">Front Logo X axis:</span>
          <button
        ...
        <div className="flex items-center space-x-2">
          <span className="text-gray-700">Front Logo Y axis:</span>
          <button
            className="border border-gray-300 rounded-md p-2"
        ...
        <div className="flex items-center space-x-2">
          <span className="text-gray-700">Front Logo Z axis:</span>
          <button
            className="border border-gray-300 rounded-md p-2"
        ...
        <div className="flex items-center space-x-2">
          <span className="text-gray-700">Front Logo Size:</span>
          <button
            className="border border-gray-300 rounded-md p-2"
      ...
      <div className="flex flex-col space-y-2 mt-4">
        <div className="flex items-center space-x-2">
          <span className="text-gray-700">Back Logo X axis:</span>
          <button
            className="border border-gray-300 rounded-md p-2"
        ...
        <div className="flex items-center space-x-2">
          <span className="text-gray-700">Back Logo Y axis:</span>
          <button
            className="border border-gray-300 rounded-md p-2"
        ...
        <div className="flex items-center space-x-2">
          <span className="text-gray-700">Back Logo Z axis:</span>
          <button
            className="border border-gray-300 rounded-md p-2"
        ...
        <div className="flex items-center space-x-2">
          <span className="text-gray-700">Back Logo Size:</span>
          <button
            className="border border-gray-300 rounded-md p-2"
